...
const greyModeBtn = document.getElementById("grmodebtn");
greyModeBtn.checked = localStorage.getItem("grmode");
greyModeBtn.addEventListener("input", () => {
    if (greyModeBtn.checked) {
        localStorage.setItem("grmode", "yes");
    } else {
        localStorage.removeItem("grmode");
    }
});
