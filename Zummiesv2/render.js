...
function render() {
    ...
    if (pinkMode) { // its referred to pinkmode but its not actually pink
        map.color = "rgb(132,237,86)";
        // this is straight up lime
        map.background = "rgb(255,124,52)";
        // this shit is red-orange??? u will see
    }
    if (greyMode) {
        map.color = "rgb(0, 0, 0)";
        map.background = "rgb(204, 204, 204)";
    }
