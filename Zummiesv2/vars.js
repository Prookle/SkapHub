    ...
    textures: {
       ...
       hats: {
            ...
            onigiri: {
                ...
                textOffset: -2.5,
                size: [2.1, 2.1],
                texture: loadImage("https://skap.io/textures/hats/ramen.png")
            },
            taria: {
                offset: [-1.3, -2.4],
                textOffset: -2.4,
        ...
        skins: {
            ...
            // Lupta: loadImage("skins/wolfer.png"),
            ...
            // asdasdzxs2: loadImage("skins/pot.png"),
        },
...
function loadSettings() {
    ...
    greyMode = Boolean(localStorage.getItem("grmode"));
...
let viewWS = false;
let noUS = false;
const devs = [/*"NKY", "NKY5223", "NKYv2", "NKYv3", "NKYv4", "3225YKN", */"SkapClientAdmin", "ZeroTix", "ZeroFix", "haha0201", "RayhanADev", "ban","Mohy"];
const banned = [];
